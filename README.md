...
```powershell
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/FatCat112/Win-server-2022/main/Post-execution-audit-log.ps1" -OutFile "$env:USERPROFILE\Desktop\Post-execution-audit-log.ps1"
